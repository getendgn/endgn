...
app = Flask(__name__)
app.config['CELERY_BROKER_URL'] = os.getenv("CELERY_BROKER_URL", "amqp://localhost")
...
def generate_content_route():
    ...
    if submission_id:
        ...
        for platform in platforms:
            generate_content_for_platform.delay(platform, AIRTABLE_BASE_ID, submission_id)
        return jsonify({"message": "Content generation tasks submitted."})
    else:
